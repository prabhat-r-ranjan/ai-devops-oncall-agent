...
class OnCallAgentService:
    ...
    def _skipped_repository_analysis(self):
        return {
            "enabled": False,
            "status": "SKIPPED",
            "message": "Repository analysis skipped because FixPlan is not safely auto-fixable.",
        }
    ...
    def _skipped_manifest_update(self):
        return {
            "enabled": False,
            "status": "SKIPPED",
            "message": "Manifest update skipped because repository analysis or FixPlan was not eligible.",
        }
    ...
    def _skipped_ai_review(self):
        return {
            "enabled": False,
            "status": "SKIPPED",
            "message": "AI review skipped because manifest was not updated in memory.",
        }
    ...
    def _skipped_pull_request(self):
        return {
            "enabled": False,
            "status": "SKIPPED",
            "message": "Pull request skipped because no safe manifest update was available.",
        }